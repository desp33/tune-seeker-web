...
import { getPodcastCategoryBySlug, getPodcastsByCategorySlug } from '@/services/podcastService';
...
const PodcastPage: React.FC = () => {
  ...
  useEffect(() => {
    if (slug) {
      // Fetch the category and related podcasts
      const categoryData = getPodcastCategoryBySlug(slug);
      const podcastsData = getPodcastsByCategorySlug(slug);
    ...
    return (
      <div className="min-h-screen bg-streamr-dark text-white flex items-center justify-center">
        <div className="text-center">
          <p className="text-streamr-gray mb-4">Podcast category not found</p>
